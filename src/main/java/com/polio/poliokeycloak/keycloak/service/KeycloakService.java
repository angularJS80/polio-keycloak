...
public class KeycloakService {
    ...
    public boolean isPubic(String targetUrl) {
        AntPathMatcher antPathMatcher = new AntPathMatcher();
        return hasNoPermissionsPatterns().stream().anyMatch(uri-> antPathMatcher.match(uri,targetUrl));
    }

    public boolean isProtected(String targetUrl) {
        AntPathMatcher antPathMatcher = new AntPathMatcher();
        return hasPermissionsPatterns().stream().anyMatch(uri-> antPathMatcher.match(uri,targetUrl));
    }
